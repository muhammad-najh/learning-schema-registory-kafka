 ...
 */
package com.skysoft.learnKafka.event;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5101860113535424993L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.skysoft.learnKafka.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"default\":0},{\"name\":\"fullName\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"email\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static com.skysoft.learnKafka.event.UserCreatedEvent.Builder newBuilder() {
    return new com.skysoft.learnKafka.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.skysoft.learnKafka.event.UserCreatedEvent.Builder newBuilder(com.skysoft.learnKafka.event.UserCreatedEvent.Builder other) {
    return new com.skysoft.learnKafka.event.UserCreatedEvent.Builder(other);
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.skysoft.learnKafka.event.UserCreatedEvent.Builder newBuilder(com.skysoft.learnKafka.event.UserCreatedEvent other) {
    return new com.skysoft.learnKafka.event.UserCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.skysoft.learnKafka.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.skysoft.learnKafka.event.UserCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skysoft.learnKafka.event.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skysoft.learnKafka.event.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skysoft.learnKafka.event.UserCreatedEvent.Builder setFullName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skysoft.learnKafka.event.UserCreatedEvent.Builder clearFullName() {
      fullName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skysoft.learnKafka.event.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.skysoft.learnKafka.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
